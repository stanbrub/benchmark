...
class Snippets {
	 ...
	 * ex. mytable = verify_api_kafka_consume('mytopic', 'append')
	 ...
	 */
	static String verify_api_kafka_consume = 
		"""
	...
	static String verify_api_await_table_size = 
		"""
	...
	static String getFunctions(String query) {
		String functionDefs = "";
		functionDefs += getFunction("verify_api_kafka_consume", verify_api_kafka_consume, query);
		functionDefs += getFunction("verify_api_await_table_size", verify_api_await_table_size, query);
		return functionDefs;
	}
