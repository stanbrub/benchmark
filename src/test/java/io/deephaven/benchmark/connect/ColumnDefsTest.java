...
public class ColumnDefsTest {
    ...
    public void add() {
        ...
        assertEquals("[100.0, 101.0, 102.0, 103.0, 104.0, 105.0]", columnDefs.columns.get(1).maker().values.toString(),
                "Wrong field maker");
        assertEquals(100.0f, columnDefs.nextValue(1, 1), "Wrong field next");

        assertEquals("[100, 101, 102, 103, 104, 105]", columnDefs.columns.get(2).maker().values.toString(),
                "Wrong field maker");
