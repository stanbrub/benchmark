# Test Class - io.deephaven.verify.tests.query.join.NaturalJoinAndJoin3Tables
...
table_gen_parquet = '/data/verify.FgaGIjU.1.ttaTig.gen.parquet'
...
'''
table_gen_def_file = '/data/verify.FgaGIjU.1.ttaTig.gen.def'
...
table_gen_parquet = '/data/verify.FgaGKpo.1.5mH8Mw.gen.parquet'
...
'''
table_gen_def_file = '/data/verify.FgaGKpo.1.5mH8Mw.gen.def'
...
table_gen_parquet = '/data/verify.FgaGKvg.1.3y_1UA.gen.parquet'
...
animal_id,int,[1-250]
'''
table_gen_def_file = '/data/verify.FgaGKvg.1.3y_1UA.gen.def'
...
````
table_parquet = '/data/animals.parquet'
table_gen_parquet = '/data/verify.FgaGLko.1.2Z4aoQ.gen.parquet'
table_gen_def_text = '''row.count=250
compression=ZSTD
isfixed=true
name,type,values
...
animal_name,string,animal[1-250]
'''
table_gen_def_file = '/data/verify.FgaGLko.1.2Z4aoQ.gen.def'
...
````
table_parquet = '/data/adjectives.parquet'
table_gen_parquet = '/data/verify.FgaGLmw.1.7eoR7w.gen.parquet'
table_gen_def_text = '''row.count=644
compression=ZSTD
isfixed=true
name,type,values
...
adjective_name,string,[1-644]
'''
table_gen_def_file = '/data/verify.FgaGLmw.1.7eoR7w.gen.def'
...
````
table_parquet = '/data/relation.parquet'
table_gen_parquet = '/data/verify.FgaGLqY.1.t3hXsQ.gen.parquet'
table_gen_def_text = '''row.count=100000
compression=ZSTD
isfixed=true
name,type,values
...
animal_id,int,[1-250]
'''
table_gen_def_file = '/data/verify.FgaGLqY.1.t3hXsQ.gen.def'
