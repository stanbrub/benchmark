...
table_gen_parquet = '/data/verify.FgaE_Wg.1.IZzEEw.gen.parquet'
...
'''
table_gen_def_file = '/data/verify.FgaE_Wg.1.IZzEEw.gen.def'
...
table_gen_parquet = '/data/verify.FgaFBdw.1.qmX8mA.gen.parquet'
...
'''
table_gen_def_file = '/data/verify.FgaFBdw.1.qmX8mA.gen.def'
...
table_gen_parquet = '/data/verify.FgaFBj4.1.hgZ6yA.gen.parquet'
...
animal_id,int,[1-250]
'''
table_gen_def_file = '/data/verify.FgaFBj4.1.hgZ6yA.gen.def'
...
````
table_parquet = '/data/animals.parquet'
table_gen_parquet = '/data/verify.FgaFCeY.1.56LMnA.gen.parquet'
table_gen_def_text = '''row.count=250
compression=ZSTD
isfixed=true
name,type,values
...
animal_name,string,animal[1-250]
'''
table_gen_def_file = '/data/verify.FgaFCeY.1.56LMnA.gen.def'
...
````
table_parquet = '/data/adjectives.parquet'
table_gen_parquet = '/data/verify.FgaFCgY.1.3yci-Q.gen.parquet'
table_gen_def_text = '''row.count=644
compression=ZSTD
isfixed=true
name,type,values
...
adjective_name,string,[1-644]
'''
table_gen_def_file = '/data/verify.FgaFCgY.1.3yci-Q.gen.def'
...
````
table_parquet = '/data/relation.parquet'
table_gen_parquet = '/data/verify.FgaFCkM.1.mnJWKw.gen.parquet'
table_gen_def_text = '''row.count=100000
compression=ZSTD
isfixed=true
name,type,values
...
animal_id,int,[1-250]
'''
table_gen_def_file = '/data/verify.FgaFCkM.1.mnJWKw.gen.def'
