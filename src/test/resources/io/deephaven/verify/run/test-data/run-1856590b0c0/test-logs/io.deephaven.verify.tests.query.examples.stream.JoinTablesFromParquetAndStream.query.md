# Test Class - io.deephaven.verify.tests.query.examples.stream.JoinTablesFromParquetAndStream
...
table_gen_parquet = '/data/verify.FgaFPAo.1.I6KSMw.gen.parquet'
...
'''
table_gen_def_file = '/data/verify.FgaFPAo.1.I6KSMw.gen.def'
...
table_gen_parquet = '/data/verify.FgaFPCc.1.5Y1wag.gen.parquet'
...
sells,int,[1-100]
'''
table_gen_def_file = '/data/verify.FgaFPCc.1.5Y1wag.gen.def'
...
````
table_parquet = '/data/stock_info.parquet'
table_gen_parquet = '/data/verify.FgaFPnQ.1.zVf89g.gen.parquet'
table_gen_def_text = '''row.count=10000
compression=ZSTD
isfixed=true
name,type,values
...
exchange,string,EXCHANGE[1-10]
'''
table_gen_def_file = '/data/verify.FgaFPnQ.1.zVf89g.gen.def'
...
````
table_parquet = '/data/stock_trans.parquet'
table_gen_parquet = '/data/verify.FgaFPpE.1._jlp-Q.gen.parquet'
table_gen_def_text = '''row.count=100000
compression=ZSTD
isfixed=false
name,type,values
...
sells,int,[1-100]
'''
table_gen_def_file = '/data/verify.FgaFPpE.1._jlp-Q.gen.def'
