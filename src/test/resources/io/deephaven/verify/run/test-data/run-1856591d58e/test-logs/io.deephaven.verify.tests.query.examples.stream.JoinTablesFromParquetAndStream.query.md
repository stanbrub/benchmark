...
table_gen_parquet = '/data/verify.FgaGe1A.1._O6JuA.gen.parquet'
...
'''
table_gen_def_file = '/data/verify.FgaGe1A.1._O6JuA.gen.def'
...
table_gen_parquet = '/data/verify.FgaGe20.1.7yXPzg.gen.parquet'
...
sells,int,[1-100]
'''
table_gen_def_file = '/data/verify.FgaGe20.1.7yXPzg.gen.def'
...
````
table_parquet = '/data/stock_info.parquet'
table_gen_parquet = '/data/verify.FgaGfe0.1.gH_9Vg.gen.parquet'
table_gen_def_text = '''row.count=10000
compression=ZSTD
isfixed=true
name,type,values
...
exchange,string,EXCHANGE[1-10]
'''
table_gen_def_file = '/data/verify.FgaGfe0.1.gH_9Vg.gen.def'
...
````
table_parquet = '/data/stock_trans.parquet'
table_gen_parquet = '/data/verify.FgaGfgk.1.ppHh0g.gen.parquet'
table_gen_def_text = '''row.count=100000
compression=ZSTD
isfixed=false
name,type,values
...
sells,int,[1-100]
'''
table_gen_def_file = '/data/verify.FgaGfgk.1.ppHh0g.gen.def'
