# Test Class - io.deephaven.verify.tests.query.KafkaToParquetStream
...
table_gen_parquet = '/data/verify.FgaFOsQ.1.tuSCzw.gen.parquet'
...
qty,int,1
'''
table_gen_def_file = '/data/verify.FgaFOsQ.1.tuSCzw.gen.def'
